...
; la línea típica consiste en un nemónico seguido de operandos. Estos deben estar separados por comas
...
; Definición de constantes mediante la pseudoinstrucción 'equ', el ':' es obligatorio para definir la constante
...
popi: equ  -1
popu: equ  3
      other_instr popo, r1, r15    ;las referencias a constantes no llevan el ':'
...
; se pueden definir en una línea por sí solas o en conjunto con una instrucción, pero siempre añadiendo el ':', lo mismo que 
; con las constantes
